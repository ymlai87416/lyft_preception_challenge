from model import BilinearUpsampling, SepConv_BN, Argmax, relu6
import keras
...
try:
    # Add additional layer information to custom_objects
    net_model = load_model(weight_file_path, custom_objects={'BilinearUpsampling':BilinearUpsampling, 'Argmax':Argmax, "backend": K, "keras": keras, "relu6": relu6})
